...
export default function Topbar({setFeature}) {
    ...
    const handleMobileNav = (event, feat) => {
    ...
    return (
        <div className='flex flex-row justify-center items-center xl:hidden block'>
            ...
            <button className='border-l border-gray-700 pl-4 px-2 py-2 justify-center items-center text-gray-300 hover:animate-pulse duration-200 font-semibold md:block hidden' onClick={() => setFeature("account")}>Account</button>
                    ...
                    <div className='absolute top-0 left-0 w-full h-screen bg-gray-600'>
                        <div className='flex flex-col pt-5 pl-10 pr-10'>
                            ...
                            <div className='flex flex-col  pt-10 pb-10 border rounded-md bg-gradient-to-r from-gray-900 to-gray-700 '>
                                <button className='font-extrabold px-2 py-2 hover:scale-110 duration-200' onClick={(event) => handleMobileNav(event, "coding")}>Code</button>
                                <button className='font-extrabold px-2 py-2 hover:scale-110 duration-200' onClick={(event) => handleMobileNav(event, "projects")}>Projects</button>
                                <button className='font-extrabold px-2 py-2 hover:scale-110 duration-200' onClick={(event) => handleMobileNav(event, "account")}>Account</button>
                            </div>  
                        </div>    
                    </div>   
                ) : (
